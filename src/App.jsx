...
function ScrollProgressBar () {
  ...
  return (
    <motion.div
      className='fixed left-0 right-0 top-0 z-[100] h-[3px] origin-left hero-gradient'
      style={{ scaleX }}
    />
  )
}
      ...
      <div className='mx-auto max-w-6xl px-6'>
        <div className='mb-10 flex flex-col gap-4 md:mb-14 md:flex-row md:items-end md:justify-between'>
          <motion.div variants={itemVariants}>
            ...
            <h2 className='mt-3 font-display text-[36px] leading-[1.02] tracking-[-0.01em] text-text md:text-[52px]'>
              {title}
            </h2>
          </motion.div>
          {subtitle ? (
            <motion.p
              ...
              className='max-w-xl text-[16px] leading-7 text-muted'
            >
              {subtitle}
            </motion.p>
          ) : null}
  ...
  return (
    <header className='sticky top-0 z-50 border-b border-white/70 bg-white/80 backdrop-blur-xl'>
      <div className='mx-auto flex max-w-6xl items-center justify-between px-6 py-4'>
        <Link
          to='/'
          className='font-display text-3xl font-semibold tracking-[-0.03em] text-accent'
        >
          MG
        </Link>
      ...
      <div className='mx-auto max-w-6xl px-6'>
        <div className='grid gap-10 lg:grid-cols-[1fr_1.08fr] lg:items-center'>
          ...
          >
            <motion.p
              variants={itemVariants}
              className='font-mono text-[12px] uppercase tracking-[0.34em] text-accent'
            >
              Hello, I’m
            </motion.p>
            ...
            <motion.h1
              variants={itemVariants}
              className='mt-4 font-display text-[40px] leading-[0.95] tracking-[-0.02em] text-text sm:text-[56px] md:text-[84px] lg:text-[90px]'
            >
              Malaika Guljahan
            </motion.h1>
            ...
            <motion.p
              variants={itemVariants}
              className='mt-4 max-w-xl text-[17px] leading-8 text-muted md:text-[18px]'
            >
              Curious minds create meaningful change. I'm Malaika Gul Jahan, an
              English linguistics graduate, researcher, and lifelong learner
              passionate about education, language, and innovation.
            </motion.p>
            ...
            >
              {[
                ...
                <a
                  key={href}
                  href={href}
                  className='inline-flex h-11 w-11 items-center justify-center rounded-full border border-slate-200 bg-white text-accent shadow-[0_12px_28px_rgba(15,23,42,0.06)] transition hover:-translate-y-1 hover:border-accent hover:bg-accent hover:text-white'
                >
                  <Icon size={16} />
                </a>
              ))}
          ...
          >
            ...
            <div className='glass-panel relative overflow-hidden rounded-[2.6rem] bg-white p-4 md:p-5 lg:p-6'>
              ...
              <div className='relative min-h-[380px] sm:min-h-[460px] md:min-h-[560px] lg:min-h-[620px]'>
                <figure className='relative min-h-[380px] sm:min-h-[460px] md:min-h-[560px] lg:min-h-[620px] overflow-hidden ...'>
  ...
  return (
    <SectionFrame>
      <div className='grid gap-8 lg:grid-cols-[1fr_1fr] lg:items-center'>
        <motion.div
          variants={itemVariants}
          className='overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_18px_40px_rgba(15,23,42,0.08)]'
        >
          <img
            src={heroFloralSrc}
        ...
        <motion.div variants={itemVariants} className='space-y-5'>
          <div>
            ...
            <h3 className='mt-3 font-display text-[34px] leading-[1.05] text-text md:text-[42px]'>
              Malaika Guljahan
            </h3>
          </div>
          ...
          <p className='max-w-xl text-[16px] leading-8 text-slate-700'>
            I Malaika Gul, an English Linguistics graduate, researcher, and
            lifelong learner passionate about language, education, and
            innovation. My interests lie at the intersection of linguistics,
            artificial intelligence, and educational technology, where I explore
            how research and digital solutions can enhance learning. Through
            research, teaching projects, digital marketing, and continuous
            professional development, I have built strong skills in
            communication, critical thinking, and problem-solving. This
            portfolio reflects my journey, achievements, and commitment to
            making a meaningful impact through education and research.
          </p>
          <div className='flex flex-wrap gap-3'>
            {languages.map(language => (
              <span
                key={language}
                className='rounded-full border border-slate-200 bg-white px-4 py-2 text-sm text-slate-700 shadow-[0_10px_24px_rgba(15,23,42,0.05)]'
              >
                {language}
              </span>
            ))}
...
function ServicesSection () {
  ...
  return (
    <SectionFrame
      ...
      eyebrow='What I Do'
      title='My Services'
      subtitle='Personalized English Coaching
        ...
        {expertise.map(group => {
          ...
          return (
            <motion.article
              ...
              variants={itemVariants}
              whileHover={{ y: -8 }}
              className='group rounded-[1.8rem] border border-slate-200 bg-white p-6 shadow-[0_14px_30px_rgba(15,23,42,0.06)] transition hover:border-accent hover:shadow-[0_20px_45px_rgba(56,189,248,0.18)]'
            >
              ...
              <h3 className='mt-5 text-center font-display text-[28px] text-text'>
                {group.title}
              </h3>
...
function ProjectsSection () {
  return (
    <SectionFrame
      ...
      subtitle='The Impact of Artificial Intelligence on English Language Learning (Self-Directed Research Project)
 Foundational Principles of Language Teaching (TESOL Video Presentation)
 ESL Lesson Plan & Teaching Materials (Lesson plans, worksheets, quizzes, and classroom activities)'
      className='bg-[#f8fafc]'
    >
      <motion.div
        variants={sectionVariants}
      ...
      >
        {projects.map(project => (
          <motion.article
            ...
            variants={itemVariants}
            whileHover={{ y: -8 }}
            className='group overflow-hidden rounded-[1.8rem] border border-slate-200 bg-white shadow-[0_14px_30px_rgba(15,23,42,0.06)] transition hover:border-accent hover:shadow-[0_20px_46px_rgba(56,189,248,0.18)]'
          >
            <div className='h-40 hero-gradient opacity-90' />
            <div className='p-6'>
              <div className='flex items-start justify-between gap-3'>
                <span className='rounded-full border border-sky-200 bg-sky-50 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.24em] text-accent'>
                  {project.tag}
                </span>
                <ExternalLink
                  size={16}
                  className='text-accent opacity-70 transition group-hover:opacity-100'
                />
              </div>
              <h3 className='mt-5 font-display text-[28px] leading-[1.05] text-text'>
                {project.title}
              </h3>
...
function SkillsExperienceSection () {
  return (
    <SectionFrame
      id='skills'
      eyebrow='Professional Depth'
      title='Skills & Experience'
      subtitle='The structure stays calm and premium while still showing the teaching and marketing depth behind the portfolio.'
      className='bg-white'
    >
      <div className='grid gap-6 lg:grid-cols-[1.05fr_0.95fr]'>
        <motion.div
          variants={itemVariants}
          className='rounded-[1.8rem] border border-slate-200 bg-white p-6 shadow-[0_14px_30px_rgba(15,23,42,0.06)] md:p-8'
        >
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <p className='mt-1 font-display text-[30px] text-text'>
                Core Skills
              </p>
            </div>
          </div>
          ...
          <div className='mt-6 flex flex-wrap gap-3'>
            {expertise
              ...
              .map(skill => (
                <span
                  key={skill}
                  className='rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-[14px] text-slate-600 transition hover:border-accent hover:bg-sky-50 hover:text-accent'
                >
                  {skill}
                </span>
              ))}
        ...
        <motion.div variants={itemVariants} className='space-y-4'>
          {experience.map(entry => (
            <article
              key={entry.role}
              className='rounded-[1.8rem] border border-slate-200 bg-white p-6 shadow-[0_14px_30px_rgba(15,23,42,0.06)] transition hover:-translate-y-1 hover:border-accent hover:shadow-[0_20px_46px_rgba(56,189,248,0.18)] md:p-7'
            >
              <div className='flex flex-col gap-3 md:flex-row md:items-start md:justify-between'>
                <div>
                  <h3 className='font-display text-[30px] leading-[1.05] text-text'>
                    {entry.role}
                  </h3>
          ...
          <div className='grid gap-4 sm:grid-cols-2'>
            {education.map(item => (
              <div
                key={item.title}
                className='rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-[0_14px_30px_rgba(15,23,42,0.06)]'
              >
                <div className='flex items-center gap-3'>
...
function ContactSection ({ onOpenCv }) {
  return (
    <SectionFrame
      ...
      title='Open to collaborations and teaching opportunities'
      subtitle='If you’re looking for a polished, student-friendly portfolio experience, this is the best place to start.'
      className='bg-[#f8fafc]'
    >
      <div className='grid gap-6 lg:grid-cols-[1.05fr_0.95fr]'>
        <motion.div
          variants={itemVariants}
          className='rounded-[2rem] border border-slate-200 bg-white p-6 shadow-[0_16px_34px_rgba(15,23,42,0.08)] md:p-8'
        >
          <p className='font-mono text-[11px] uppercase tracking-[0.3em] text-accent'>
            Get in touch
          </p>
          <div className='mt-5 space-y-4'>
            <a
              ...
              className='flex items-center justify-between rounded-[1.25rem] border border-slate-200 bg-slate-50 px-4 py-4 transition hover:border-accent hover:bg-sky-50 hover:text-accent'
            >
              <span className='inline-flex items-center gap-3 text-[15px] text-slate-700'>
        ...
        <motion.div
          variants={itemVariants}
          className='rounded-[2rem] hero-gradient p-[1px] shadow-[0_16px_34px_rgba(56,189,248,0.22)]'
        >
          <div className='rounded-[calc(2rem-1px)] bg-white p-6 md:p-8'>
            ...
            <p className='mt-4 text-[17px] leading-8 text-slate-700'>
              The CV opens in a polished browser viewer with no download button,
              keeping the experience clean and professional.
            </p>
            <div className='mt-6 flex flex-col gap-3 sm:flex-row'>
              <GlowButton onClick={onOpenCv}>
                View CV <SquareArrowOutUpRight size={16} />
              </GlowButton>
              <GlowButton
                href='/cv'
                ...
                variant='secondary'
              >
                Open CV page <ExternalLink size={16} />
              </GlowButton>
            </div>
            <div className='mt-8 rounded-[1.5rem] bg-[linear-gradient(135deg,rgba(56,189,248,0.12),rgba(186,230,253,0.45))] p-5'>
              <p className='font-display text-[28px] text-text'>
                Available for opportunities
              </p>
              <p className='mt-2 text-[15px] leading-7 text-slate-600'>
                English teaching, educational content, tutoring, SEO, and
                digital support.
              </p>
            </div>
          </div>
      ...
      <div className='mx-auto max-w-5xl rounded-[2rem] border border-slate-200 bg-white shadow-[0_18px_40px_rgba(15,23,42,0.12)]'>
        <div className='flex items-center justify-between border-b border-slate-200 px-6 py-5 md:px-8'>
          <div>
            ...
            <h1 className='mt-2 font-display text-[30px] text-text md:text-[42px]'>
              {profile.name}
            </h1>
          </div>
          <button
        ...
        <div className='grid gap-0 lg:grid-cols-[1fr_1fr]'>
          <section className='border-b border-slate-200 p-6 lg:border-b-0 lg:border-r md:p-8'>
            <div className='text-center'>
              <p className='font-display text-[26px] tracking-[0.06em] text-slate-600'>
                SUMMARY
              </p>
            ...
            <div className='mt-8'>
              <p className='font-display text-[20px] tracking-[0.08em] text-slate-600'>
                EDUCATION
              </p>
            ...
            <div className='mt-8'>
              ...
              <div className='mt-2 h-px w-36 bg-slate-400' />
              <p className='mt-4 text-[13px] tracking-[0.2em] text-slate-700'>
                {cv.languages.join(' | ')}
              </p>
            </div>
          </section>
          ...
          <section className='p-6 md:p-8'>
            ...
            <div className='mt-8 border-t border-slate-200 pt-5 text-[13px] text-slate-700'>
              <div className='flex items-end justify-between gap-4'>
                <div>
                  <p className='font-semibold uppercase tracking-[0.08em] text-slate-600'>
                    PORTFOLIO (CLICK OR SCAN)
                  </p>
                  <p className='mt-1'>
                    View Documents Portfolio or Scan QR Code
                  </p>
                </div>
    ...
    <>
      ...
      <AnimatePresence mode='wait' initial={false}>
        <Routes location={location} key={location.pathname}>
          <Route
            path='/'
            element={<HomePage onOpenCv={() => setCvOpen(true)} />}
          />
          <Route
            path='/cv'
            element={
      ...
      <AnimatePresence>
        {cvOpen ? (
          <motion.div
            className='fixed inset-0 z-[120] overflow-y-auto bg-slate-950/75 px-4 py-8 backdrop-blur-xl md:px-6'
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          >
